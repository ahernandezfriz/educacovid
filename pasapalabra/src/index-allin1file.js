...
const inputName = $('#name').attr('required', '');
...
// función que cambia el aspecto de la pantallla cuando se presiona el botón de play again, 
// se ocultan los elementos actuales y se muestra de nuevo la pantalla inicial con las instrucciones y con los valores reseteados.
function playAgain() {
  initializeVariables();
  containerWin.hide();
  containerGame.hide();
